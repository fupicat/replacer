...
const portunhol = '{"inputs":["en","em","in","ó","ão","ões","m ","é "," o "," a "," as "," os ","ães","lh"," h","ç","x","seu","sua","teu","o","tua","sq","que"," da ","ue "," do ","ueu"," e ","ar "," ie","ues","at","nh"," na "," no "," nas "," nos ","é"], "outputs":["ien","ien","en","ue","ión","iones","n ","es "," lo "," la "," las "," los ","iones","ll","j","cc","s","su","su","tu","ue","tu","zq","quie"," de la ","o "," del ","o"," y ","iar "," e","os","act","ñ"," en la "," en el "," en las "," en los ","es"]}';
